...
public class UsuarioDTO {
	...
	public UsuarioDTO(String nombre, String apellido, long telefono, String email, String password, String ciudad,
	...
	public String toString() {
		return "UsuarioDTO [id=" + id + ", nombre=" + nombre + ", apellido=" + apellido + ", telefono=" + telefono
	...
	@Override
	public int hashCode() {
		return Objects.hash(apellido, ciudad, direccion, email, id, nombre, password, rol, telefono);
	}
